...
class ControllerCustomerCustomer extends Controller
{
    ...
    public function import ()
    {
        ...
        $data[ 'deleteImp' ] = $this->url->link( 'customer/customer/deleteImp', 'user_token=' . $this->session->data[ 'user_token' ] . '&customer_id=' . $this->request->get[ 'customer_id' ], true );

        $data[ 'imports' ] = array();

        $results = $this->model_customer_customer->getImports( $this->request->get[ 'customer_id' ], ( $page - 1 ) * 10, 10 );
